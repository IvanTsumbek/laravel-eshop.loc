            ...
            <div class="col-lg-3 col-md-4">
                <div class="sidebar">
                    ...
                    <div class="collapse collapse-filters" id="collapseFilters">
                        ...
                        @if ($selected_filters)
                            <button class="btn btn-outline-warning w-100 mb-3" wire:click="clearFilters">Clear
                                filters</button>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" aria-label="Sort by:" wire:change="changeSort"
                                    ...
                                    @foreach ($sortList as $k => $item)
                                        <option value="{{ $k }}"
                                            @if ($k == $sort) selected @endif
                                            wire:key="{{ $k }}">{{ $item['title'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" aria-label="Show:" wire:change="changeLimit"
                                    ...
                                    @foreach ($limitList as $k => $item)
                                        <option @if ($k == $limit) selected @endif
